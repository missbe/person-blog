...
<script>
  ...
  $(document).ready(function() {
                ...
                },
                {
                    ...
                    action: function (dom) {
                        ...
                        if(selected.length==0){
                            ...
                            bootstrap_confirm("确认推荐/取消推荐以下"+selected.length+"项吗？",text,function(){
                                var ids = new Array(selected.length);
                                for(var i =0 ; i<selected.length;i++){
                                    ids[i] = selected[i][0];
                                }
                                ...
                                submit(data, "user/blog/${className}/changeRecommend", dom, function(res){
                                    if(res.success){
                                        oTable.ajax.reload( null, false );
                                    }
                                });
        ...
        $('.dt-buttons').addClass('col-md-8 pull-left');
