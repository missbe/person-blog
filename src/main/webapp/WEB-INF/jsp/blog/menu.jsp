...
<head>
<meta charset="gb2312">
<title>${menu.name}-${blogInfo.realName}-Missbe</title>
...
<article class="blogs">
<h1 class="t_nav"><span>${menu.content} </span><a href="<%=basePath %>blog/${account}.html" class="n1">网站首页</a><a href="<%=basePath %>blog/${account}/menu/${menu.id}.html" class="n2">${menu.name}</a></h1>
