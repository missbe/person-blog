...
public class WildcardMatcher {
    ...
    /**
     * Empty construct, since all the methods are static, you don't ha
     * ve to make an object of this class,
    ...
    /**
     * Give the boolean value whether the given file name and the wild
     * card matches.
     *
     ...
     * @param string     The source string to be compared to the wildcard.
     * @param wildcard   The wildcard.
     * @param ignorecase If this param is true, all the comparison is
     *                   made not casesensitive.
     * @return True, if they matches.
     */
    public static boolean match(String string, String wildcard, boolean
        ...
        if (wildcard.equals("*"))
            return true;
        String sub = null;
        int pw = 0, ps = 0, wlen = wildcard.length(), index;
        boolean first = true;
        while (pw < wlen) {
     ...
     * tring.equals, except that it
     * supports wildcard "?"
     *
     * @param a A string to compare
     * @param b A string to compare
     * @return True If a and b equals, notice that this could be invol
     * ve wildcard "?"
     */
    private static boolean stringEquals(String a, String b) {
        int alen = a.length(), blen = b.length();
        return alen == blen && find(a, b, 0) == 0;
    }

    /**
     * Find the match position of the two string, it is same as String
     * .indexOf, except that it supports
     * wildcard "?"
     *
    ...
    private static boolean charEqualsIgnoreCase(char a, char b) {
        ...
        return at == UPPERCASE && bt == LOWERCASE && a + 'a' - 'A' == b;
    }
